        ...
        {({ values }) => {
          useEffect(() => {
            ...
            const lgmedEmails = users
              .filter((user) => user.jobPosition === "placeholder LGMED")
              .map((user) => user.email);
            const lgcddEmails = users
              .filter((user) => user.jobPosition === "placeholder LGCDD")
              .map((user) => user.email);
            const ordEmails = users
              .filter((user) => user.jobPosition === "placeholder ORD")
              .map((user) => user.email);
            const fadEmails = users
              .filter((user) => user.jobPosition === "placeholder FAD")
              .map((user) => user.email);
            const pdmuEmails = users
              .filter((user) => user.jobPosition === "placeholder PDMU")
              .map((user) => user.email);
            const rictuEmails = users
              .filter((user) => user.jobPosition === "placeholder RICTU")
              .map((user) => user.email);
            const legalEmails = users
              .filter((user) => user.jobPosition === "placeholder LEGAL")
              .map((user) => user.email);
